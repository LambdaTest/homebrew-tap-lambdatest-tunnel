...
```bash
git clone https://github.com/LambdaTest/homebrew-tap-lambdatest-tunnel
```

Or simply add the tap and install directly using Homebrew.
...
```bash
brew tap lambdatest/tap-lambdatest-tunnel
brew install lambdatest-tunnel
```

Once installed, start the tunnel with your TestMu AI credentials:

```bash
lambdatest-tunnel --user YOUR_USERNAME --key YOUR_ACCESS_KEY
```
